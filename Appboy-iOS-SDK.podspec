Pod::Spec.new do |s|
  ...
  s.subspec 'NewsFeed' do |snf|
    ...
    snf.resource_bundle = { 'ABKNewsFeed' => 'AppboyUI/ABKNewsFeed/Resources/**/*.*' }
  ...
  s.subspec 'InAppMessage' do |siam|
    ...
    siam.resource_bundle = { 'ABKInAppMessage' => 'AppboyUI/ABKInAppMessage/Resources/*.*' }
  ...
  s.subspec 'ContentCards' do |scc|
    ...
    scc.resource_bundle = { 'ABKContentCards' => 'AppboyUI/ABKContentCards/Resources/**/*.*' }
